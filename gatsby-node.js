...
exports.createPages = async ({ graphql, actions, reporter }) => {
  ...
  // Define a template for recipes post
  const recipePost = path.resolve(`./src/templates/recipe-post.js`)

  // Get all markdown recipes posts sorted by date
  ...
  if (result.errors) {
    reporter.panicOnBuild(
      `There was an error loading your recipes posts`,
      result.errors
    )
    return
  }
...
exports.createSchemaCustomization = ({ actions }) => {
  ...
  // recipes posts are stored inside "content/recipes" instead of returning an error
  createTypes(`
